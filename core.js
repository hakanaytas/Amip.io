...
export const MAX_SPEED = 195;      // normal (boost'suz) hız — "yürüme" hissi için düşürüldü
export const MIN_SPEED = 55;
export const BOOST_MULT = 1.28;    // boost artık "bir tık" hızlanma — aşırı sıçrama yok
export const BOOST_COST_PER_SEC = 14;
export const SPEED_LERP_RATE = 7;  // hız geçişinin ne kadar akıcı/yumuşak olacağı
